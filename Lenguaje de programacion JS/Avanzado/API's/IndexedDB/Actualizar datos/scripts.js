...
//funcion que nos dara la informacion del elemento que vamos a actualizar
//todo es casi igual que en aññadir datos
    const getData = (key) => {
        const transaction = db.transaction(['tasks'], 'readwrite')
        const objectStore = transaction.objectStore('tasks')
//get nos ayudar a abtener los datos
...
//creacion de los botones Update y Delete
